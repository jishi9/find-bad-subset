...
class TestFindBadSubset(unittest.TestCase):
    ...
    def test_run_script(self):
        with createUnopenedTemporary() as temp_filename:
            command = ['./FindBadSubset.py',
                ...
                # Success if the file does not contain the letter 'x'. Note the use of '@' to escape the leading dash.
            ...
            # Run command, and find the last print out of 'good', 'bad' and 'unknown' sets
            ...
            self.assertEqual(good_set, set(['an innocuous element', 'hello', 'this string is ok']))
    ...
    def parse_set(self, line):
        ...
        self.assertEqual(len(element_list), len(element_set), 'Set contains duplicates')
        return element_set
